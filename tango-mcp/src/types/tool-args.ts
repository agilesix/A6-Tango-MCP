...
export interface SearchContractsArgs {
	...
	/**
	 * Funding agency name or code
	 * The agency providing the funds (may differ from awarding agency)
	 *
	 * @example "Department of Defense"
	 * @example "DOD"
	...
	/**
	 * Earliest period of performance start date to include
	 * Format: YYYY-MM-DD
	 *
	 * @example "2024-01-01"
	 * @example "2023-10-01" - Start of fiscal year
	 */
	pop_start_date_after?: string;

	/**
	 * Latest period of performance start date to include
	 * Format: YYYY-MM-DD
	 *
	 * @example "2024-12-31"
	 * @example "2024-09-30" - End of fiscal year
	 */
	pop_start_date_before?: string;

	/**
	 * Earliest period of performance end date to include
	 * Format: YYYY-MM-DD
	 *
	 * @example "2024-01-01"
	 */
	pop_end_date_after?: string;

	/**
	 * Latest period of performance end date to include
	 * Format: YYYY-MM-DD
	 *
	 * @example "2024-12-31"
	 */
	pop_end_date_before?: string;

	/**
	 * Filter contracts expiring on or after this date
	 * Based on ultimate period of performance end date
	 * Format: YYYY-MM-DD
	 *
	 * @example "2024-01-01"
	 * @example "2025-06-30"
