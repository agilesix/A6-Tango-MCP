 ...
 */
export interface TangoGrantOpportunityDetailResponse
	extends TangoGrantOpportunityResponse {
 ...
 */
export interface TangoOpportunityDetailResponse
	extends TangoOpportunityResponse {
